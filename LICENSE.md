...
6. This license applies only to this repository's original materials, including documentation, configuration files, metadata, and files created specifically for this modpack.

7. This license does not apply to third-party mods, libraries, APIs, resource packs, shaders, tools, or external projects referenced by this repository. Those projects remain under their own respective licenses and belong to their respective authors.
